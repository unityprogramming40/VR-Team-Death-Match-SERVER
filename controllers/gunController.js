...
const GunsData = [
    ...
    new GunData(101, "", 0, [0, 0, 0], [0, 0, 0], 20, 20, 20, 1),
    new GunData(1011, "", 0, [0, 0, 0], [0, 0, 0], 20, 20, 20, 1),

    new GunData(102, "", 0, [0, 0, 0], [0, 0, 0], 30, 30, 20, 2),
    new GunData(1022, "", 0, [0, 0, 0], [0, 0, 0], 30, 30, 20, 2),

    new GunData(103, "", 0, [0, 0, 0], [0, 0, 0], 35, 35, 12, 3),
    new GunData(1033, "", 0, [0, 0, 0], [0, 0, 0], 35, 35, 12, 3),
    ...
    new GunData(202, "", 0, [0, 0, 0], [0, 0, 0], 12, 12, 40, 2),
    new GunData(2022, "", 0, [0, 0, 0], [0, 0, 0], 12, 12, 40, 2),

    new GunData(203, "", 0, [0, 0, 0], [0, 0, 0], 35, 35, 18, 3),
    new GunData(2033, "", 0, [0, 0, 0], [0, 0, 0], 35, 35, 18, 3),

    new GunData(204, "", 0, [0, 0, 0], [0, 0, 0], 25, 25, 35, 1),
    new GunData(2044, "", 0, [0, 0, 0], [0, 0, 0], 25, 25, 35, 1),


    new GunData(301, "", 0, [0, 0, 0], [0, 0, 0], 30, 30, 20, 1),
    new GunData(3011, "", 0, [0, 0, 0], [0, 0, 0], 30, 30, 20, 1),

    new GunData(302, "", 0, [0, 0, 0], [0, 0, 0], 30, 30, 22, 2),
    new GunData(3022, "", 0, [0, 0, 0], [0, 0, 0], 30, 30, 22, 2),

    new GunData(303, "", 0, [0, 0, 0], [0, 0, 0], 40, 40, 12, 3),
    new GunData(3033, "", 0, [0, 0, 0], [0, 0, 0], 40, 40, 12, 3),

    new GunData(304, "", 0, [0, 0, 0], [0, 0, 0], 35, 35, 10, 1),
    new GunData(3044, "", 0, [0, 0, 0], [0, 0, 0], 35, 35, 10, 1),
];
